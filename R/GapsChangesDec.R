...
#'
#' @description This function detects forest canopy gap changes across two forest gap [`terra::SpatRaster`] objects
#'
#' @usage GapChangeDec(gap_layer1,gap_layer2)
#'
#' @param gap_layer1 ALS-derived gap as an [`terra::SpatRaster`] object at time 1. (output of  [getForestGaps()] function).
#' @param gap_layer2 ALS-derived gap as an [`terra::SpatRaster`] object at time 2. (output of  [getForestGaps()] function).
#' @return A [`terra::SpatRaster`] object representing forest gap change area
...
#'
#' rast(ALS_CHM_CAU_2012)
#' rast(ALS_CHM_CAU_2014)
#'  
